...
def job():
    ...
    t_env.execute_sql('''
                    CREATE TABLE SINK (
                                        VL_ISS INT,
                                        DT_FECHTO_CREDENCIADA TIMESTAMP,
                                        CD_CREDENCIADA INT,
                                        ...
                                        DT_CREDENCIADA_FECHTO TIMESTAMP,
                                        ...
                                        DT_GLOSA_CONVENIO TIMESTAMP,
                                        DT_GLOSA_PBM_SUBSIDIO TIMESTAMP,
                                        DT_GLOSA_PBM_REPASSE TIMESTAMP,
                                        CD_PBR INT,
                                        VL_ESTORNO_GLOSA_CONVENIO INT,
                                        DT_ESTORNO_GLOSA_CONVENIO TIMESTAMP,
                                        CD_TIPO_GLOSA INT,
                                        CD_TIPO_GLOSA_PBMR INT,
                                        CDS_CHAVE_ACESSO_NFE STRING,
                                        DT_CONFIRMACAO_TRACKING TIMESTAMP,
                                        ID_NF INT,
