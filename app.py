...
def job():
    ...
    output_type=Types.ROW([Types.INT() ,Types.SQL_TIMESTAMP(3) ,Types.INT() ,Types.INT() ,Types.INT() ,Types.STRING() ,Types.INT() ,Types.INT() ,Types.SQL_TIMESTAMP(3) ,Types.SQL_TIMESTAMP(3) ,Types.INT() ,Types.INT() ,Types.INT() ,Types.STRING() ,Types.INT() ,Types.STRING() ,Types.STRING() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.STRING() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.SQL_TIMESTAMP(3) ,Types.SQL_TIMESTAMP(3) ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.SQL_TIMESTAMP(3) ,Types.INT() ,Types.INT() ,Types.INT() ,Types.STRING() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.SQL_TIMESTAMP(3) ,Types.SQL_TIMESTAMP(3) ,Types.SQL_TIMESTAMP(3) ,Types.INT() ,Types.INT() ,Types.SQL_TIMESTAMP(3) ,Types.INT() ,Types.INT() ,Types.STRING() ,Types.SQL_TIMESTAMP(3) ,Types.INT() ,Types.INT() ,Types.INT() ,Types.INT() ,Types.SQL_TIMESTAMP(3)]))
    # Saída
    t_env.execute_sql('''
                    CREATE TABLE SINK (
                                        vl_iss int ,
