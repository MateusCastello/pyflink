...
def job():
    ...
    t_env.execute_sql('''
                    CREATE TABLE SINK (
                                        vl_iss int ,
                                        dt_fechto_credenciada TIMESTAMP(6),
                                        cd_credenciada int ,
                                        ...
                                        dt_credenciada_fechto TIMESTAMP(6) ,
                                        ...
                                        vl_sinal_saldo int ,
                                        dt_fechto TIMESTAMP(6) ,
                                        dt_faturamento TIMESTAMP(6) ,
                                        ...
                                        dt_glosa_convenio TIMESTAMP(6) ,
                                        dt_glosa_pbm_subsidio TIMESTAMP(6) ,
                                        dt_glosa_pbm_repasse TIMESTAMP(6) ,
                                        cd_pbr int ,
                                        vl_estorno_glosa_convenio int ,
                                        dt_estorno_glosa_convenio TIMESTAMP(6) ,
                                        cd_tipo_glosa int ,
                                        cd_tipo_glosa_pbmr int ,
                                        cds_chave_acesso_nfe varchar ,
                                        dt_confirmacao_tracking TIMESTAMP(6) ,
                                        id_nf int ,
                                        cd_operacao_fiscal int ,
                                        cd_filial_origem int ,
                                        cd_filial_destino int ,
                                        dt_evento TIMESTAMP(6)
                                    )
                WITH (
                        'connector.type' = 'jdbc',
