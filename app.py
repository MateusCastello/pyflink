...
def job():
    ...
    output_type=Types.ROW([Types.INT(),Types.SQL_DATE(),Types.INT(),Types.INT(),Types.INT(),Types.STRING(),Types.INT(),Types.INT(),Types.SQL_DATE(),Types.SQL_DATE(),Types.INT(),Types.INT(),Types.INT(),Types.STRING(),Types.INT(),Types.STRING(),Types.STRING(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.STRING(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.SQL_DATE(),Types.SQL_DATE(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.SQL_DATE(),Types.INT(),Types.INT(),Types.INT(),Types.STRING(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.SQL_DATE(),Types.SQL_DATE(),Types.SQL_DATE(),Types.INT(),Types.INT(),Types.SQL_DATE(),Types.INT(),Types.INT(),Types.STRING(),Types.SQL_DATE(),Types.INT(),Types.INT(),Types.INT(),Types.INT(),Types.SQL_DATE()])
    )
    # Saída
    t_env.execute_sql('''
                    CREATE TABLE sync (
